...
import { ProvisionStoresOptions, Stores, UnprovisionStoresOptions } from '../stores/types'
...
export type DataFormatsAndRelationsObj = { dataFormats: DataFormats, relations: Relations }

export type ConnectedTsPgOrm<
...
> = TsPgOrm<TDataFormats, TRelations, TVersionTransforms, true>
...
// Initially, only data formats and their order are present.
{
   ...
   */
  dataFormatOrder: StringKeysOf<TDataFormats>[]
  /**
...
& IncludeIfObjectIsNotEmpty<TRelations, (
  ...
  & IncludeIfTrue<TConnected, {
     ...
     */
    stores: Stores<TDataFormats, TRelations>
  } & StoreProvisioners<TDataFormats, TRelations>>
